<template>
    <div id="box">
      ...
      <div class="title">
        待付款
        <p class="surplus_tate">   剩余29分钟自动关闭</p>
      </div>
      <!--师傅位置-->
      <div class="serve_position">
      ...
      <!--已完成-->
      <div class="keep_container" v-if="accomplish">
        <ul class="mui-table-view">
          <li class="mui-table-view-cell">
            <p class="cause_top">
              <span class="cause_type">双门维修</span>
        ...
        <div class="defray_content">
          <div class="defray_right open_price">
            <p>
              已付款
              <span class="defray_price">￥30 </span>
      ...
      <div class="identifier">
        <p>订单编号：201708172000000001</p>
        <p> 下单时间：2017-09-09 </p>
      </div>
      <!--结算和评价-->
      <div class="footer" v-show="false">
          <router-link to="/comment" class="accounts_btn" href="javascript:;">去评价</router-link>
          <a class="accounts_btn cancel" href="javascript:;">取消订单</a>
        <p class="amount">合计：<span>￥300</span></p>
      </div>
      <!--去评价-->
      <div class="footer" v-show="false">
        <router-link to="/comment" class="accounts_btn" href="javascript:;">去评价</router-link>
      ...
      <!--确认付款-->
      <div class="footer" v-show="false">
          <a class="accounts_btn" href="javascript:;">确认付款</a>
        <p class="amount">合计：<span>￥300</span></p>
      </div>
      <!--取消订单-->
      <div class="footer" v-show="true">
          <a class="accounts_btn cancel" @click="cancel" href="javascript:;">取消订单</a>
      </div>
      <!--代付尾款-->
      <div class="serve_position wk" @click="isShowWk">尾款合计：￥510
        <span class="inventory">尾款支付清单</span>
        <i class="right_icon right_wk"></i>
      </div>

        <ul class="district_list" ref="myUl" v-show="isShow">
          <li  v-for="(item,index) in inventoryList" :key="item.name">
            <span class="type_left">压缩机线束</span>
            <span class="price_right">￥222</span>
          </li>
        </ul>
        ...
        methods: {
          isShowWk(){
           ...
           if(this.isShow){
            ...
            MessageBox({
              title: '提示',
              message: '2小时内订单扣除30手续费',
              showCancelButton:true,
              confirmButtonClass:"queRen",
              cancelButtonClass:"quX",
              cancelButtonText:" ",
